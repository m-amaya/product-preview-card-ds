...
/*/ @preserve
    ...
    Built: 2022-08-02 13:34:09.520Z
*/

import * as Z from 'react';
import Z__default, { createContext, useContext, useState, useRef, useEffect, useLayoutEffect } from 'react';
...
var rgba = function (hex, alpha) {
    return hexRgb(hex, { alpha: alpha, format: "css" });
};

var _a;
function replace(vars, template) {
    var tokens = {};
    for (var key in vars) {
        tokens[key] = template.replace("%", "".concat(vars[key]));
    }
    return tokens;
}
var styled = (_a = q({
    ...
    utils: {
        ...
        // box model
        noSpace: function () { return ({
            margin: 0,
            padding: 0,
        }); },
        // animation
        smoothTransition: function (properties) { return ({
...
var stitches_config = /*#__PURE__*/Object.freeze({
    __proto__: null,
    styled: styled,
    css: css,
    globalCss: globalCss,
...
var Button = function (_a) {
    ...
    _b = _a.kind, 
    // props
    kind = _b === void 0 ? "primary" : _b, 
    // handlers
    // common
    className = _a.className, css = _a.css, testId = _a.testId, children = _a.children, attrs = __rest(_a, ["kind", "className", "css", "testId", "children"]);
    return (Z__default.createElement(ButtonStyled, __assign({}, attrs, { kind: kind, className: className, css: css, "data-testid": testId }), children));
};
...
var SvgArrowLeft = function SvgArrowLeft(props) {
  return /*#__PURE__*/Z.createElement("svg", _extends$1({
    width: "1em",
    height: "1em",
    viewBox: "0 0 15 16",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), _path$1 || (_path$1 = /*#__PURE__*/Z.createElement("path", {
...
var SvgArrowRight = function SvgArrowRight(props) {
  return /*#__PURE__*/Z.createElement("svg", _extends({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), _path || (_path = /*#__PURE__*/Z.createElement("path", {
...
var Icon = function (_a) {
    var 
    // props
    name = _a.name, _b = _a.color, color = _b === void 0 ? "currentColor" : _b, _c = _a.size, size = _c === void 0 ? 16 : _c, 
    // handlers
    // common
    className = _a.className, css = _a.css, testId = _a.testId, attrs = __rest(_a, ["name", "color", "size", "className", "css", "testId"]);
    var IconSvg = ICONS[name];
    var IconStyled = styled(IconSvg, {
        color: color,
    });
    return (Z__default.createElement(IconStyled, __assign({}, attrs, { height: size, width: size, viewBox: '0 0 16 16', css: css, className: className, "data-testid": testId })));
};
...
function useCopyToClipboard() {
    var _this = this;
    var _a = useState(""), copiedText = _a[0], setCopiedText = _a[1];
...
function useFocus(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = useState(defaultState), isFocused = _c[0], setFocus = _c[1];
    useEffect(function () {
        ...
        return function () {
            var _a, _b;
            (_a = ref.current) === null || _a === void 0 ? void 0 : _a.removeEventListener("focus", onFocus);
            (_b = ref.current) === null || _b === void 0 ? void 0 : _b.removeEventListener("blur", onBlur);
        };
    }, [ref, isDisabled]);
    return {
        isFocused: isFocused,
...
function useTargetBoundary(ref, _a) {
    var isDisabled = _a.isDisabled, onMouseDownInside = _a.onMouseDownInside, onMouseDownOutside = _a.onMouseDownOutside, onMouseUpInside = _a.onMouseUpInside, onMouseUpOutside = _a.onMouseUpOutside;
    useLayoutEffect(function () {
        ...
        var mouseDownListener = function (e) {
            var _a;
            if (onMouseDownInside && ((_a = ref.current) === null || _a === void 0 ? void 0 : _a.contains(e.target))) {
                onMouseDownInside(e);
                return;
            }
        ...
        var mouseUpListener = function (e) {
            var _a;
            if (onMouseUpInside && ((_a = ref.current) === null || _a === void 0 ? void 0 : _a.contains(e.target))) {
                onMouseUpInside(e);
                return;
            }
            if (onMouseUpOutside) {
...
function useFocusWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = useState(defaultState), isFocusedWithin = _c[0], setFocusWithin = _c[1];
    var isFocused = useFocus(ref, { defaultState: defaultState, isDisabled: isDisabled }).isFocused;
    useTargetBoundary(ref, {
        isDisabled: isDisabled,
        onMouseDownInside: function () { return setFocusWithin(true); },
        onMouseDownOutside: function () { return setFocusWithin(false); },
    });
    return {
...
function useHover(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = useState(defaultState), isHovered = _c[0], setHover = _c[1];
    useEffect(function () {
        var onMouseEnter = function () { return setHover(true); };
        var onMouseLeave = function () { return setHover(false); };
        if (ref.current && !isDisabled) {
...
function useMediaQuery() {
    ...
    var isGteTablet = windowWidth && windowWidth >= breakpoints.tablet;
    var isGteDesktop = windowWidth && windowWidth >= breakpoints.desktop;
    var isMobile = !isGteTablet && !isGteDesktop;
    return {
        isMobile: isMobile,
        isGteTablet: isGteTablet,
        isGteDesktop: isGteDesktop,
    };
}

function usePress(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = useState(defaultState), isPressed = _c[0], setPress = _c[1];
    useEffect(function () {
        var onMouseDown = function () { return setPress(true); };
        var onMouseUp = function () { return setPress(false); };
        if (ref.current && !isDisabled) {
        ...
        return function () {
            var _a, _b;
            (_a = ref.current) === null || _a === void 0 ? void 0 : _a.removeEventListener("mousedown", onMouseDown);
            (_b = ref.current) === null || _b === void 0 ? void 0 : _b.removeEventListener("mouseup", onMouseUp);
        };
    }, [ref, isDisabled]);
    return {
        isPressed: isPressed,
...
function usePressWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = useState(defaultState), isPressedWithin = _c[0], setPressWithin = _c[1];
    useTargetBoundary(ref, {
        isDisabled: isDisabled,
        onMouseDownInside: function () { return setPressWithin(true); },
        onMouseUpInside: function () { return setPressWithin(false); },
    });
    return {
        isPressedWithin: isPressedWithin,
    };
}

function useUniqueId(prefix) {
    var id = v4();
    var uniqueId = useState(prefix ? "".concat(prefix, "-").concat(id) : id)[0];
    return uniqueId;
}

export { Button, ICONS, Icon, genKey, globalStyles, instance as i18n, rgba, stitches_config as stitches, tokens, useCopyToClipboard, useFocus, useFocusWithin, useHover, useLocalStorage, useLockedBody, useMediaQuery, usePress, usePressWithin, useTargetBoundary, useTranslation, useUniqueId, useWindowSize };
