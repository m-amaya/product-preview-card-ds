...
var Icon = function (_a) {
    ...
    return (React__default["default"].createElement(IconStyled, __assign({}, attrs, { height: size, width: size, viewBox: '0 0 16 16', css: css, className: className, "data-testid": testId })));
};
...
var Button = function (_a) {
    ...
    return (React__default["default"].createElement(ButtonStyled, __assign({}, attrs, { className: className, css: css, "data-testid": testId }),
        React__default["default"].createElement(Inner, null,
            iconName && React__default["default"].createElement(Icon, { name: iconName, size: 16 }),
            React__default["default"].createElement(ButtonText, null, children))));
};
...
function useCopyToClipboard() {
    var _this = this;
    var _a = React.useState(""), copiedText = _a[0], setCopiedText = _a[1];
...
function useFocus(ref, _a) {
    ...
    var _c = React.useState(defaultState), isFocused = _c[0], setFocus = _c[1];
    React.useEffect(function () {
...
function useFocusWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = React.useState(defaultState), isFocusedWithin = _c[0], setFocusWithin = _c[1];
...
function useHover(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = React.useState(defaultState), isHovered = _c[0], setHover = _c[1];
    React.useEffect(function () {
...
function usePress(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = React.useState(defaultState), isPressed = _c[0], setPress = _c[1];
    React.useEffect(function () {
...
function usePressWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = React.useState(defaultState), isPressedWithin = _c[0], setPressWithin = _c[1];
    useTargetBoundary(ref, {
        isDisabled: isDisabled,
...
function useUniqueId(prefix) {
    var id = v4();
    var uniqueId = React.useState(prefix ? "".concat(prefix, "-").concat(id) : id)[0];
    return uniqueId;
}
...
exports.rgba = rgba;
exports.stitches = stitches_config;
...
exports.usePressWithin = usePressWithin;
exports.useTargetBoundary = useTargetBoundary;
