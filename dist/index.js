...
var Button = function (_a) {
    ...
    return (Z__default["default"].createElement(ButtonStyled, __assign({}, attrs, { kind: kind, className: className, css: css, "data-testid": testId }), children));
};
...
var SvgArrowLeft = function SvgArrowLeft(props) {
  return /*#__PURE__*/Z__namespace.createElement("svg", _extends$1({
    width: "1em",
    height: "1em",
    viewBox: "0 0 15 16",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), _path$1 || (_path$1 = /*#__PURE__*/Z__namespace.createElement("path", {
...
var SvgArrowRight = function SvgArrowRight(props) {
  return /*#__PURE__*/Z__namespace.createElement("svg", _extends({
    width: "1em",
    height: "1em",
    viewBox: "0 0 15 16",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props), _path || (_path = /*#__PURE__*/Z__namespace.createElement("path", {
...
var Icon = function (_a) {
    ...
    return (Z__default["default"].createElement(IconStyled, __assign({}, attrs, { height: size, width: size, viewBox: '0 0 16 16', css: css, className: className, "data-testid": testId })));
};
...
var i18nInstance;
var I18nContext = Z.createContext();
...
function useTranslation(ns) {
  ...
  var _ref = Z.useContext(I18nContext) || {},
...
function useCopyToClipboard() {
    var _this = this;
    var _a = Z.useState(""), copiedText = _a[0], setCopiedText = _a[1];
...
function useFocus(ref, _a) {
    ...
    var _c = Z.useState(defaultState), isFocused = _c[0], setFocus = _c[1];
    Z.useEffect(function () {
...
function useFocusWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = Z.useState(defaultState), isFocusedWithin = _c[0], setFocusWithin = _c[1];
...
function useHover(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = Z.useState(defaultState), isHovered = _c[0], setHover = _c[1];
    Z.useEffect(function () {
...
function usePress(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = Z.useState(defaultState), isPressed = _c[0], setPress = _c[1];
    Z.useEffect(function () {
...
function usePressWithin(ref, _a) {
    var _b = _a.defaultState, defaultState = _b === void 0 ? false : _b, isDisabled = _a.isDisabled;
    var _c = Z.useState(defaultState), isPressedWithin = _c[0], setPressWithin = _c[1];
    useTargetBoundary(ref, {
        isDisabled: isDisabled,
...
function useUniqueId(prefix) {
    var id = v4();
    var uniqueId = Z.useState(prefix ? "".concat(prefix, "-").concat(id) : id)[0];
    return uniqueId;
}
